...
class FiltersTestCase(unittest.TestCase):
    ...
    def test_bpFilter(self):
        ...
        bf = bp_filter(edge_in_eV=1.42, OD=2)
        abs_spec=bf.get_spectrum(wavelength_unit='nm')
    ...
    def test_draw_filtered_spectrum(self):
        ...
        ill.attenuation_single(bp_filter(edge_in_eV=edge, OD=2))
        ...
        above_bg_spec=orig_spec[orig_spec[:,0]<(eVnm(edge)-10),:]

        filtered_above_bg_spec=filtered_spec[orig_spec[:,0]<(eVnm(edge)-10),:]
